        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <div className="text-base text-brand-500 font-bold font-elegant italic mt-2 tracking-wide">
                  &quot; የቤትዎን ቁልፍ በጊዜ ይረከቡ! &quot;
                </div>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://t.me/fanuel_properties" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.tiktok.com/@fanuel_akoya" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.facebook.com/share/1MjNBeMYRb/" target="_blank" rel="noopener noreferrer" 
              ...
              <a href="https://t.me/fanuel_akoya" target="_blank" rel="noopener noreferrer"
                 className="w-10 h-10 bg-blue-500 hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors duration-300">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                <a href="mailto:fanikeme@gmail.com" className="text-brand-400 hover:text-brand-300 transition-colors duration-200">
                  <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </a>
                <div>
                  <a href="mailto:fanikeme@gmail.com" className="text-gray-300 hover:text-brand-400 text-sm transition-colors duration-200 font-text">fanikeme@gmail.com</a>
                  <p className="text-xs text-gray-400 mt-1 font-text">
