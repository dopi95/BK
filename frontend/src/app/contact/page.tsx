      ...
      <div className="container mx-auto px-4 py-8 sm:py-16 pb-40">
        ...
        <div className="mb-16 sm:mb-20 animate-fade-in-up delay-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 max-w-4xl mx-auto">
            ...
            <a href="https://www.facebook.com/share/1MjNBeMYRb/" target="_blank" rel="noopener noreferrer" className="group bg-white dark:bg-gray-800 p-4 sm:p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-center">
            ...
            <a href="https://tiktok.com/@fanuel_akoya" target="_blank" rel="noopener noreferrer" className="group bg-white dark:bg-gray-800 p-4 sm:p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-center">
