...
const translations = {
  en: {
    ...
    propertiesDescription: 'Discover our carefully selected premium properties in prime locations',
    viewDetails: 'View Details',
    tourThreeD: '3D Tour',
    viewMoreProperties: 'View More Properties',
    viewLessProperties: 'View Less Properties',
  ...
  am: {
    ...
    featuredProperties: 'የተመረጡ ንብረቶች',
    propertiesDescription: 'በመሪ አካባቢዎች ውስጥ የተመረጡ አቅም ንብረቶችን ያግኙ',
    viewDetails: 'ዝርዝሮችን ይመልከቱ',
    tourThreeD: '3D ጥዋፍ',
    viewMoreProperties: 'ተጨማሪ ንብረቶችን ይመልከቱ',
    viewLessProperties: 'የተቀለሉ ንብረቶችን ይመልከቱ',
    viewOnMap: 'በጉግል ማፕ ላይ ይመልከቱ',
